                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mr-16">
                        ...
                        <div className="text-center group">
                            <div className="relative inline-block mb-4">
                                <GaugeComponent
                                    value={getValue('Em1_Energy') / 1000}
                                    type="radial"
                                    minValue={0}
                                    maxValue={getValue('Em1_Energy') / 1000 + 1000}
                                    labels={{
                                        tickLabels: {
                                            type: "inner",
                                            ticks: [
                                                { value: (getValue('Em1_Energy') / 1000 + 1000) * 0.25 },
                                                { value: (getValue('Em1_Energy') / 1000 + 1000) * 0.5 },
                                                { value: (getValue('Em1_Energy') / 1000 + 1000) * 0.75 },
                                                { value: getValue('Em1_Energy') / 1000 + 1000 }
                                            ]
                                        },
                                        valueLabel: {
                                    ...
                                    arc={{
                                        ...
                                        subArcs: [{ 
                                            limit: (getValue('Em1_Energy') / 1000 + 1000) * 0.4 
                                        }, { 
                                            limit: (getValue('Em1_Energy') / 1000 + 1000) * 0.8 
                                        }, {}],
                                        padding: 0.02,
                                        width: 0.25
                                    }}
                            ...
                            <p className="text-gray-400 text-sm mt-1">{(getValue('Em1_Energy') / 1000).toFixed(1)} kWh</p>
                        </div>
                        ...
                        <div className="text-center group">
                            <div className="relative inline-block mb-4">
                                <GaugeComponent
                                    value={getValue('Em1_power') / 1000}
                                    type="radial"
                                    minValue={0}
                                    maxValue={getValue('Em1_power') / 1000 + 1000}
                                    labels={{
                                        tickLabels: {
                                            type: "inner",
                                            ticks: [
                                                { value: (getValue('Em1_power') / 1000 + 1000) * 0.25 },
                                                { value: (getValue('Em1_power') / 1000 + 1000) * 0.5 },
                                                { value: (getValue('Em1_power') / 1000 + 1000) * 0.75 },
                                                { value: getValue('Em1_power') / 1000 + 1000 }
                                            ]
                                        },
                                        valueLabel: {
                                    ...
                                    arc={{
                                        colorArray: ['#22c55e', '#eab308','#ef4444'],
                                        subArcs: [{ 
                                            limit: (getValue('Em1_power') / 1000 + 1000) * 0.4 
                                        }, { 
                                            limit: (getValue('Em1_power') / 1000 + 1000) * 0.8 
                                        }, {}],
                                        padding: 0.02,
                                        width: 0.25
                                    }}
                            ...
                            <p className="text-gray-400 text-sm mt-1">{(getValue('Em1_power') / 1000).toFixed(1)} kW</p>
                        </div>
                        ...
                        <div className="text-center group">
                            ...
                            <p className="text-gray-400 text-sm mt-1">{getValue('Em1_voltage').toFixed(3)} V</p>
                        </div>
                        ...
                        <div className="text-center group">
                            ...
                            <p className="text-gray-400 text-sm mt-1">{getValue('Em1_current').toFixed(1)} A</p>
                        </div>
                        ...
                        <div className="text-center group">
                            ...
                            <p className="text-gray-400 text-sm mt-1">{getValue('Em1_PF').toFixed(1)}</p>
                        </div>
                    </div>
                </div>
            </div>
