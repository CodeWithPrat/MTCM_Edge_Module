          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mr-16">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-400 text-sm mt-1">
                {(getValue("Em1_Energy") / 1000).toFixed(1)} kWh
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-400 text-sm mt-1">
                {(getValue("Em1_power") / 1000).toFixed(1)} kW
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-400 text-sm mt-1">
                {getValue("Em1_voltage").toFixed(3)} V
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-400 text-sm mt-1">
                {getValue("Em1_current").toFixed(1)} A
              </p>
            </div>
